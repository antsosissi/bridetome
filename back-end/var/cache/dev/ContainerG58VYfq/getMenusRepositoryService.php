 ...
 */
class getMenusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MenusRepository' shared autowired service.
     *
     * @return \App\Repository\MenusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MenusRepository.php';

        return $container->privates['App\\Repository\\MenusRepository'] = new \App\Repository\MenusRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
